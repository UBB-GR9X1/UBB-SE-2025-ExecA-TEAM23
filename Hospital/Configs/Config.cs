namespace Hospital.Configs
{
    ...
    {//2
        ...
        private string _databaseConnection = "Data Source=DESKTOP-HGL99LI\\SQLEXPRESS;Initial Catalog=HospitalApp;Integrated Security=True;TrustServerCertificate=True";
