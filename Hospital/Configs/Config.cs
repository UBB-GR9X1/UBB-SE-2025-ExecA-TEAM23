...
namespace Hospital.Configs
{
    class Config
    {
        ...
        private string _databaseConnection = "Data Source=DESKTOP-M2TF6Q6\\SQLEXPRESS;Initial Catalog=HospitalApp;Integrated Security=True;TrustServerCertificate=True";
