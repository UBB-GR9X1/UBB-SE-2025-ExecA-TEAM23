// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LoggerDatabaseService.cs" company="Hospital">
//   Copyright (c) Hospital. All rights reserved. Licensed under the MIT License.
// </copyright>
// <summary>
//   Defines the LoggerDatabaseService class for database logging operations.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
namespace Hospital.DatabaseServices
{
    ...
    public class LoggerDatabaseService : ILoggerService
    {
        ...
        private async Task<List<LogEntryModel>> ExecuteLogRetrievalQuery(string query, SqlParameter[]? parameters)
        {
            try
            {
                using SqlConnection connection = new SqlConnection(this.configProvider.GetDatabaseConnection());
